...
/*
        Hamiltonian path means visiting each vertex exactly once
    ...
    Hamiltonian cycle --- > A -> B -> C -> E -> D -> F -> A
...
public class HamiltonianCycle {
    ...
    public void solve() {
        hamiltonianPath[0] = 0;
        // if we are able to find the solution for position 1,
    ...
    private boolean findSolution(int position) {
        ...
        for (int vertexIndex = 1; vertexIndex < numOfVertices; vertexIndex++) {
            ...
            if (isValid(vertexIndex, position)) {
                ...
                // try to find solution for the next position
